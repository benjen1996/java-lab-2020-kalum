package org.aarongalvez.test.db;
...
public class Conexion {
    private final String PERSISTANCE_UNIT_NAME = "KalumPU";
    private EntityManager entityManager;
    private static Conexion instancia;

    public Conexion() {
        try {
            this.entityManager = Persistence.createEntityManagerFactory(PERSISTANCE_UNIT_NAME).createEntityManager();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
